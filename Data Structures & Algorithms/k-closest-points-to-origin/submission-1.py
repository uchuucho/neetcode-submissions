...
class Solution:
    def quickSelect(self, dist: List[Pair], s: int, e: int, k: int) -> List[Pair]:
        if e - s + 1 <= 1:
            return dist
